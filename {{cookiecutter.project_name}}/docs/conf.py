...
# sphinx-quickstart on Thu May  7 14:05:15 2015.
#
...
latex_documents = [
  (master_doc, '{{cookiecutter.project_name}}.tex', '{{cookiecutter.project_title}} Documentation',
...
man_pages = [
    (master_doc, '{{cookiecutter.project_name}}', '{{cookiecutter.project_title}} Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, '{{cookiecutter.project_name}}', '{{cookiecutter.project_title}} Documentation',
   author, '{{cookiecutter.project_name}}', '{{cookiecutter.project_description}}',
   'Miscellaneous'),
]
